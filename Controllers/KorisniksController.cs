...
namespace getfitEF.Controllers
{
    public class KorisniksController : Controller
    {
        ...
        {
            var korisniks = db.Korisniks.Include(k => k.SifSpol);
        ...
        public ActionResult Create([Bind(Include = "Id,Ime,Prezime,DatumRodjenja,Sifra,Email,Telefon")] Korisnik korisnik)
        {
            ...
            ViewBag.Sifra = new SelectList(db.SifSpols, "Sifra", "Naziv", korisnik.Sifra);
            return View(korisnik);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ime,Prezime,DatumRodjenja,Sifra,Email,Telefon")] Korisnik korisnik)
        {
            if (ModelState.IsValid)
            {
